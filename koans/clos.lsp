...
(defmethod get-value :after ((object value-with-access-counter))
  (incf (slot-value object 'access-count)))

(defmethod set-value :after (new-value (object value-with-access-counter))
  (incf (slot-value object 'access-count)))
...
(defmethod get-kind :after ((object shape))
  (setf *last-kind-accessor* :shape))

(defmethod get-kind :after ((object circle))
  (setf *last-kind-accessor* :circle))

(defmethod get-kind :after ((object color))
